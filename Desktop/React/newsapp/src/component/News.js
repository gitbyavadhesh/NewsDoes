...
const updateNews = async () => {
  ...
  // this.setState({
  //   articles: parsedData.articles, // this is class setstate
...
//   // console.log("RAm");
//   // let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=063a33a0e52248168c501e7e6064d8c4&page=1&pageSize=${props.pageSize}`;
//   // this.setState({loading: true});
//   // let data = await fetch(url);
//   //  let parsedData = await data.json()
//   //  console.log(parsedData);
...
//   // let url = `https://newsapi.org/v2/top-headlines?country=${props.country}&category=${props.category}&apiKey=063a33a0e52248168c501e7e6064d8c4&page=${this.state.page - 1}&pageSize=${props.pageSize}`;
//   //     this.setState({loading: true});
//   // let data = await fetch(url);
//   //      let parsedData = await data.json()
//   //      console.log(parsedData);
...
return (
  <>
    <h2 className="text-center" style={{ margin: "35px 0px" }}>
      NewsDoes - Top {capitalizeFirstLetter(props.category)} Headlines
    </h2>
    {loading && <Spinner />}
    <InfiniteScroll
